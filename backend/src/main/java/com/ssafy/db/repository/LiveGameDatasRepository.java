...
*/
@Repository
public interface LiveGameDatasRepository extends JpaRepository<LiveGameDatas, Integer>{

	  @Transactional
	  @Modifying
	  @Query(value = "truncate live_game_datas", nativeQuery = true)
	  void truncateLiveGameDatas();
